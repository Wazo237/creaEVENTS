        ...
        <div class="section-content blog-content">
            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-2 mt-4">
                    <h4>Une équipe toujours à l'affût des informations</h4>
                    <img class="float-left" width="320px" src="img/blog-4.jpg" alt="">
                    <p>creaEVENTS veut également dans sa branche informative permettre à ses utilisateurs d'être à l'affût des évènements du monde connecté.</p>
                    <p>creaEVENTS veut également dans sa branche statistiques permettre à ses utilisateurs d'avoir une idée des préférences du monde connecté.</p>
                    <p>creaEVENTS veut également dans sa branche témoignages permettre à ses utilisateurs de connaître le feedback des autres membres du monde connecté..</p>
                    <p>creaEVENTS veut également dans sa branche principale permettre à ses utilisateurs de créer et/ou de rejoindre des évènements à travers la plateforme.</p>
                </div>
...
<!-- End of Contact Form Section -->	</div>
