        ...
        <div class="section-content">
            ...
            <div class="title-wrap mb-5" data-aos="fade-up">
                <h2 class="section-title">
                    Bienvenue <a href="" target="_blank"><?php echo $_SESSION['User']; ?></a>
                </h2>
                <p class="section-sub-title">Nous sommes heureux de vous revoir dans votre espace personnel <br> Que voulez vous faire aujourd'hui?</p>
            </div>
                ...
                <div class="col-md-10 offset-md-1 features-holder">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 text-center mt-4">
                            <b><a href="portail_crea.php"><div class="bg-white"><div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                <div class="my-4">
                                    <i class="lnr lnr-cog fs-40"></i>
                                </div>
                                <h4>Créer un évènement</h4>
                                </div></div></a>
                                <p>Définissez le type, le lieu, la date de votre évènement personnalisé.</p>
                            </b>
                        ...
                        <div class="col-md-4 col-sm-12 text-center">
                            <a href="portail_view.php"><div class="bg-white"><div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                <div class="my-4">
                                    <i class="lnr lnr-frame-contract fs-40"></i>
                                </div>
                                <h4>Consulter évènements</h4>
                                 </div></div></a>
                                <b><p>Listez les évènements crées ou rejoints associés à votre compte</p></b>
                        ...
                        <!-- Features Item -->
                        <div class="col-md-4 col-sm-12 text-center mt-4">
                            <a href="portail_join.php"><div class="bg-white"><div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                <div class="my-4">
                                    <i class="lnr lnr-thumbs-up fs-40"></i>
                                </div>
                                <h4>Rejoindre évènement</h4>
                                 </div></div></a>
                                <b><p>Prenez part à un évènement creaEVENTS</p></b>
                            <div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                <div class="my-4">
                                </div>
