...
<div id="side-nav" class="sidenav">
  ...
  <div class="container text-center">
    ...
    <form method="post" action="api_post2.php" enctype="multipart/form-data">
                        <div class="row">
                                &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<b>Client: </b>&nbsp &nbsp<a href=""><h4> <?php echo $_SESSION['User']; ?></h4></a>
                                <br>
                                &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<b>Montant frais: </b>&nbsp &nbsp <h4><?php echo $_SESSION['eventPrice']; ?> </h4><a href=""><h4> FCFA</h4></a>
                            <div class="col-md-12 form-group">
                              <br><b>MODE DE PAIEMENT :</b>
        <br><br>
        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        &nbsp &nbsp &nbsp <input type="radio" name="pay" required="">&nbsp<img src="img/om.png" alt="portfolio-img" class="portfolio-item">
 &nbsp &nbsp<b>655152679</b> (EYOUM ALOUMBE Yann)
        <br><br>
        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        &nbsp &nbsp &nbsp <input type="radio" name="pay" required="">&nbsp<img src="img/mtn.jpg" alt="portfolio-img" class="portfolio-item">
 &nbsp &nbsp<b>672449756</b> (KALDJOB Emmanuel Landry)
        <br>
                            </div>
                             <div class="col-md-12 form-group">
