...
$req = $bdd->prepare('SELECT IDevent FROM evenements WHERE (Libelle =:lbl) AND (Createur =:crt)');
$req->execute(array(
        'lbl'=>$_SESSION['eventLibelle'],
        'crt'=>$_SESSION['User']));

while ($donnees = $req->fetch()){
    $idEV = $donnees['IDevent'];
}
$req->closeCursor();
$_SESSION['eventID']=$idEV;
?>
<!DOCTYPE html>
<html lang="en">
...
<div id="side-nav" class="sidenav">
  ...
  <div class="container text-center">
    ...
    <form method="post" action="api.php" enctype="multipart/form-data">
                        <div class="row">
                                <b>Identifiant du creaEVENTS: </b>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<h1 class="display-1 mb-4"> <?php echo $idEV; ?></h1>
                            <div class="col-md-12 form-group">
                            
                                <p>  Veuillez mémoriser cet identifiant pour pouvoir le partager, les internautes en auront besoin pour rejoindre votre évènement</p>
                            </div>
                            <div class="col-md-12 form-group">
                            
                                <h4>⚠ Seul le paiement des frais de création garantit la pérénisation de votre évènement, sans celà votre creaEVENTS sera masqué puis supprimé</h4></a>
                            </div>
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit">Procéder au paiement</button>
                            </div>
                        </div>
                    </form>
</section>
