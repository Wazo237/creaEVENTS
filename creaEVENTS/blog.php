    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-nav-header">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="temoin.php">Temoignanges</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="section-content">
            <div class="title-wrap mb-5" data-aos="fade-up">
                ...
                <p class="section-sub-title">Quelques évènements par creaEVENTS</p>
            </div>
            <div class="row">
                <!-- Blog -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up">
                            <div class="blog-item">
                                ...
                                <div class="blog-text">
                                    <div class="blog-tag">
                                        <a href="single.php"><h6><small>Jeux-vidéos</small></h6></a>
                                    </div>
                                    <div class="blog-title">
                                        <a href="single.php"><h4>La nitendo switch prends le pouvoir !</h4></a>
                                    </div>
                                    <div class="blog-meta">
                                        <p class="blog-date">26 Février 2023</p> /
                                        <p class="blog-comment"><a href="single.php">23 Comments</a></p>
                                    </div>
                                    <div class="blog-desc">
                                        <p>La nouvelle console de Nitendo est favorite parmis toutes les générations confondues.</p>
                                    </div>
                                    <div class="blog-author">
                                        <p>by TINTIE Amanda</p>
                                    </div>
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up" data-aos-delay="200">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="single.php"><img src="img/blog-2.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                                        <a href="single.php"><h6><small>Musique</small></h6></a>
                                    </div>
                                    <div class="blog-title">
                                        <a href="single.php"><h4>Concert en réalité virtuelle</h4></a>
                                    </div>
                                    <div class="blog-meta">
                                        <p class="blog-date">26 Février 2023</p> /
                                        <p class="blog-comment"><a href="single.php">23 Comments</a></p>
                                    ...
                                    <div class="blog-desc">
                                        <p>Les meilleurs choristes de France se sont essayés à un concert complétèment en réalité virtuelle.</p>
                                    </div>
                                    <div class="blog-author">
                                        <p>by PAYONG Linda</p>
                                    </div>
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up" data-aos-delay="400">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="single.php"><img src="img/blog-3.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                                        <a href="single.php"><h6><small>ECONOMY</small></h6></a>
                                    </div>
                                    <div class="blog-title">
                                        <a href="single.php"><h4>Vente aux enchères</h4></a>
                                    </div>
                                    <div class="blog-meta">
                                    ...
                                    <div class="blog-desc">
                                        <p>Une SEGA collector actuellemnt en vente aux enchères ; avis aux collectioneurs !!!</p>
                                    </div>
                                    <div class="blog-author">
                                        <p>by KOUKEM Lauriace</p>
                                    </div>
                                    <div class="blog-share-wrapper">
                                        <a class="blog-share" href="google.com">
                                            <i class="fab fa-facebook-square"></i>
        ...
        <div class="section-content" data-aos="fade-up">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="mb-2">Abbonez vous aux news creaEVENT</h2>
                    <p>Enregistrez votre adresse e-mail afin de recevoir toutes les news, annonces et offres creaEVENTS</p>
                    <a class="btn btn-outline-primary btn-lg">S'abonner</a>
                </div>
            </div>
        </div>
    </div>
