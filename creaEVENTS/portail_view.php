    ...
    <div class="container">
        <div class="section-content">
            <div class="title-wrap" data-aos="fade-up">
                <h2 class="section-title">Choisissez le <br><b>type d'évènement à consulter</b></h2>
           ...
           <center> <div class="row text-center">
                ...
                <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h5 class="mb-4">Consulter évènement crée</h5>
                    <p>Afficher la liste de tous vos creaEVENTS</p>
                    <p><a class="btn btn-link" href="eventViewConfirm1.php" role="button">Consulter</a></p>
                </div>
                <!-- /.col-md-4 col-sm-6  -->
                <div class="col-md-4 col-sm-6" data-aos="fade-up">
                    <img class="rounded-circle" src="img/icons/animat-checkmark.gif" alt="Generic placeholder image" width="140" height="140">
                    <h5 class="mb-4">Consulter évènement rejoint</h5>
                    <p>Afficher la liste de tous les creaEVENTS auquels vous participez</p>
                    <p><a class="btn btn-link" href="eventViewConfirm2.php" role="button">Consulter</a></p>
                </div>
                <!-- /.col-md-4 col-sm-6  -->
            </div></center>
            <!-- /.row -->
