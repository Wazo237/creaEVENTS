    ...
    <div class="container">
        <div class="">
            ...
            <div class="title-wrap" data-aos="fade-up">
                ...
                <p class="section-sub-title">Créez et rejoignez des milliers d'évènements grâce à nottre plateforme !!!</p>
            </div>
            <!-- End of Section Title -->
            <div class="row">
                <!-- Contact Form Holder -->
                <div class="col-md-8 offset-md-2 contact-form-holder mt-4" data-aos="fade-up">
                    <form method="post" name="contact-us" action="acceuil_post.php">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary btn-shadow btn-lg" type="submit" name="submit">VALIDER</button>
                                 &nbsp &nbsp &nbsp
                                <button class="btn btn-primary btn-shadow btn-lg" type="reset" name="reset">ANNULER</button>
                            </div>
                            &nbsp &nbsp &nbsp
                            <a href="inscription.php" class="btn btn-link p-0">
                            ...
                            <a href="contact.php" class="btn btn-link p-0">
