     ...
     <div class="container">
        ...
        <div class="section-content pt-0">
            <div class="title-wrap" data-aos="fade-up">
                <h2 class="section-title"> Joined creaEVENTS by <a href=""><?php echo $_SESSION['User'];?></a></h2>
            </div>
<?php
try
  {
...
$reponse = $bdd->prepare('SELECT event, Prixticket, Lieu, Periode FROM tickets INNER JOIN evenements
ON tickets.IDevent = evenements.IDevent WHERE acheteur=:log');
$reponse->execute(array(
  ...
  while ($donnees = $reponse->fetch()){
    ...
    $_SESSION['eventLibelle']=$donnees['event'];
    ?>
          <div class="bg-white">
          <b><a href=""><div class="shadow rounded feature-item p-4 mb-4">
            <div class="row text-center mt-4">
                <div class="col-md-3" data-aos="fade-up">
                    <span class="lnr lnr-location fs-40 py-4 d-block"></span>
                    <h5>PRIX</h5>
                    <p><?php echo $_SESSION['eventPrice']; ?> FCFA</p>
                </div>
                <div class="col-md-3" data-aos="fade-up" data-aos-delay="200">
                    <span class="lnr lnr-clock fs-40 py-4 d-block"></span>
                    <h5>DATE</h5>
                    <p><?php echo $_SESSION['eventDate']; ?></p>
                </div>
                <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                    <span class="lnr lnr-phone fs-40 py-4 d-block"></span>
                    <h5>LIEU</h5>
                    <p><?php echo $_SESSION['eventLieu']; ?></p>
                </div>
                <div class="col-md-3" data-aos="fade-up" data-aos-delay="600">
                    <span class="lnr lnr-phone fs-40 py-4 d-block"></span>
                    <h5>LIBELLE</h5>
                    <p><?php echo $_SESSION['eventLibelle']; ?></p>
                </div>
              </div>
            </div></a></b></div>
            <?php
