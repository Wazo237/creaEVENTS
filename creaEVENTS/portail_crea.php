    ...
    <div class="container">
        <div class="section-content">
            <div class="title-wrap" data-aos="fade-up">
                <h2 class="section-title">Définissez le <br><b>type d'évènement à créer</b></h2>
                <p class="section-sub-title">Choisissez parmi les types suivants:</p>
            </div>
            ...
            <div class="row text-center">
                <div class="col-md-4 col-sm-6" data-aos="fade-up">
                    ...
                    <h5 class="mb-4">Rassemblement</h5>
                    <p>Réunion officielle de personnes suivant votre cause</p>
                    <p><a class="btn btn-link" href="eventTypeConfirm1.php" role="button">Créer</a></p>
                </div>
                <!-- /.col-md-4 col-sm-6  -->
                <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h5 class="mb-4">Musical</h5>
                    <p>Concert, spectacle artistique... tout événement ayant besoin d'une sonorisation particulière</p>
                    <p><a class="btn btn-link" href="eventTypeConfirm2.php" role="button">Créer</a></p>
                </div>
                <!-- /.col-md-4 col-sm-6  -->
                <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h5 class="mb-4">Hi-Tech</h5>
                    <p>Les évènements technologiques nécéssitent des présentoirs particuliers et une sécurité et assistance aux équipements </p>
                    <p><a class="btn btn-link" href="eventTypeConfirm3.php" role="button">Créer</a></p>
                </div>
                <!-- /.col-md-4 col-sm-6  -->
            </div>
            <!-- /.row -->
